...
plt.tight_layout()
plt.show()
#takes 3-4 mins per pair, 6*5/2 = 15 * 3.5 mins
...
plt.figure(figsize=(6,4))
plt.imshow(df_counts, aspect='auto', origin='lower', cmap='viridis')
plt.colorbar(label="Number of H1 bars")
plt.xticks(range(len(thresholds)), thresholds)
plt.yticks(range(len(top6)), top6)
plt.title("H₁ bar counts vs. min_persistence")
plt.xlabel("min_persistence")
...
plt.figure(figsize=(6,4))
for ct in top6:
  plt.plot(thresholds, df_counts.loc[ct], marker='o', label=ct)
plt.legend(bbox_to_anchor=(1.05,1), loc='upper left', fontsize=8)
plt.xlabel("min_persistence")
plt.ylabel("H₁ bar count")
plt.title("H₁ bar count trend")
plt.tight_layout()
plt.show()
